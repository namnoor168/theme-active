...
corona_breadcrumbs_title(true, true, get_the_title());
						...
						<div class="entry-content">	
							...
							<div class="meta-content">
								...
								<div class="portfolio-info">
									<p class="ptsan"><?php esc_html_e('Date:', 'corona') ?></p>
								...
								if ( $categories_list ):
									?>
									<div class="portfolio-info">
										<p class="ptsan"><?php esc_html_e('Categories:', 'corona'); ?></p>
							...
							<div class="single-navigation">
								<?php
								previous_post_link('%link', esc_html__('Prev Project', 'corona'));
								next_post_link('%link', esc_html__('Next Project', 'corona'));
								?>
							</div>
