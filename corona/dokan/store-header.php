...
$store_open_notice        = isset( $store_info['dokan_store_open_notice'] ) && ! empty( $store_info['dokan_store_open_notice'] ) ? $store_info['dokan_store_open_notice'] : __( 'Store Open', 'corona' );
$store_closed_notice      = isset( $store_info['dokan_store_close_notice'] ) && ! empty( $store_info['dokan_store_close_notice'] ) ? $store_info['dokan_store_close_notice'] : __( 'Store Closed', 'corona' );
        ...
        <div class="profile-info-summery-wrapper dokan-clearfix">
                    ...
                    <ul class="dokan-store-info">
                        ...
                        <?php if ( $store_user->show_email() == 'yes' ) { ?>
                            <li class="dokan-store-email">
                                ...
                                <a href="mailto:<?php echo esc_html( antispambot( $store_user->get_email() ) ); ?>"><?php echo esc_html( antispambot( $store_user->get_email() ) ); ?></a>
                            </li>
                        <?php } ?>
            ...
            <div class="social-store">
                        <ul class="social-icons">
                            ...
                            <li><a class="facebook social-icon" title="#" href="http://facebook.com/#" target="_blank" rel="noopener noreferrer"><i class="fa fa-facebook"></i></a></li>
                            <li><a class="twitter social-icon" title="#" href="http://twitter.com/#" target="_blank" rel="noopener noreferrer"><i class="fa fa-twitter"></i></a></li>
                            <li><a class="youtube social-icon" title="#" href="https://www.youtube.com/user/#" target="_blank" rel="noopener noreferrer"><i class="fa fa-youtube-play"></i></a></li>
                            <li><a class="instagram social-icon" title="#" href="https://instagram.com/#" target="_blank" rel="noopener noreferrer"><i class="fa fa-instagram"></i></a></li>
                        </ul>
